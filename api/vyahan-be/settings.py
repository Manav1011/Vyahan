...
SECRET_KEY = 'django-insecure-msxxl69&*mw4m*enml1%&x-u0y!=#_*$d6fb(h+1_t2*t%_e9o'
...
WSGI_APPLICATION = 'vyahan-be.wsgi.application'
ASGI_APPLICATION = 'vyahan-be.asgi.application'
